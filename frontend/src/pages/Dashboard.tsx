...
// ! Convertit "2024-01-15" en date locale FR sans décalage horaire (new Date('2024-01-15') interprète en UTC → problème de fuseau horaire) !
...
export default function Dashboard() {
  ...
  // ? useFetch<ProgressionStats> : appel GET /api/stats/progression — Le générique <ProgressionStats> type la réponse pour TypeScript ?
  ...
  // ? ?. = opérateur optionnel (null-safe) pour sécuriser l'accès aux données ?
  const stats = data?.stats 

  // * Préparation des données pour Recharts : [...stats.monthly].reverse() remet les mois dans l'ordre chronologique (l'API les retourne du plus récent au plus ancien) *
